...
TOKEN = "8565925340:AAEYU8A_rthlecqIWJjwJelIlsWM0L7A1_4"
ADMIN_ID = 8086545587
...
elif call.data.startswith("mine_open"):
...
elif call.data.startswith("ap_select"):
...
elif call.data.startswith("av_mode"):
